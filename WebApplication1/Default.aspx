...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block">
                <asp:Repeater ID="Repeater7" runat="server">
                    <ItemTemplate>
                        <img class="img-fluid img-profile rounded-circle mx-auto mb-2"  src="Dosyalar/img/profile.jpg"  <%--src='<%#Eval("FOTOGRAF")%>'--%> alt="">
                    </ItemTemplate>
                </asp:Repeater>
            </span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" ><%--<form>
                        <asp:Button ID="Button1" runat="server" Text="Admin Girişi" OnClick="Button1_Click" /></form>--%></a>
                </li>
    ...
    <div class="container-fluid p-0">
                ...
                <ItemTemplate>
                    ...
                    <a href="#">
                        ...
                        <div class="social-icons">
                            <a href="linkedin.com/in/süleyman-ariş-591645196">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
            <div class="my-auto">
                <h2 class="mb-5">Ödüller Ve Etkinlikler</h2>
